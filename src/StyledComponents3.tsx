...
const AcceptButton = styled.button`padding : .5rem 1rem ; background-color : green ; font-size :24px ; font-weight : bold ; border-radius : 15px ;border : 5px solid currentColor; color : white;`
//COMPONENT
